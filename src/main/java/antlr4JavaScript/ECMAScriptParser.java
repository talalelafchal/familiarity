...
public class ECMAScriptParser extends Parser {
	...
	public final ExpressionStatementContext expressionStatement() throws RecognitionException {
		...
		try {
			...
			setState(174); expressionSequence();
			setState(175); eos();
			}
		}
		catch (RecognitionException re) {
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			...
			setState(179); expressionSequence();
	...
	public final IterationStatementContext iterationStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(190); expressionSequence();
				setState(191); match(CloseParen);
				setState(192); eos();
				}
				break;
			...
			case 2:
				...
				setState(195); match(OpenParen);
				setState(196); expressionSequence();
			...
			case 3:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
					{
					setState(202); expressionSequence();
					}
				}
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
					{
					setState(206); expressionSequence();
					}
				}
			...
			case 4:
				...
				setState(218); variableDeclarationList();
				setState(219); match(SemiColon);
				setState(221);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
					{
					setState(220); expressionSequence();
					}
				}
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
					{
					setState(224); expressionSequence();
					}
				}

				setState(227); match(CloseParen);
			...
			case 5:
				...
				enterOuterAlt(_localctx, 5);
				{
				setState(230); match(For);
				setState(231); match(OpenParen);
				setState(232); singleExpression(0);
				setState(233); match(In);
				setState(234); expressionSequence();
			...
			case 6:
				...
				setState(239); match(OpenParen);
				setState(240); match(Var);
				setState(241); variableDeclaration();
				setState(242); match(In);
				setState(243); expressionSequence();
				setState(244); match(CloseParen);
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(264);
				if (!(!here(LineTerminator))) throw new FailedPredicateException(this, "!here(LineTerminator)");
				setState(265); expressionSequence();
				}
				break;
			}
			setState(268); eos();
	...
	public final WithStatementContext withStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(270); match(With);
			setState(271); match(OpenParen);
			setState(272); expressionSequence();
			setState(273); match(CloseParen);
	...
	public final SwitchStatementContext switchStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(276); match(Switch);
			setState(277); match(OpenParen);
			setState(278); expressionSequence();
			setState(279); match(CloseParen);
			setState(280); caseBlock();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CaseBlockContext caseBlock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(282); match(OpenBrace);
			setState(284);
			_la = _input.LA(1);
			if (_la==Case) {
				{
				setState(283); caseClauses();
				}
			}
			...
			if (_la==Default) {
				{
				setState(286); defaultClause();
				setState(288);
				_la = _input.LA(1);
				if (_la==Case) {
					{
					setState(287); caseClauses();
					}
				}
	...
	public final CaseClauseContext caseClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(299); match(Case);
			setState(300); expressionSequence();
	...
	public final ThrowStatementContext throwStatement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(314); match(Throw);
			setState(315);
			if (!(!here(LineTerminator))) throw new FailedPredicateException(this, "!here(LineTerminator)");
			setState(316); expressionSequence();
			setState(317); eos();
			}
		}
		catch (RecognitionException re) {
	...
	public final TryStatementContext tryStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(319); match(Try);
				setState(320); block();
				setState(321); catchProduction();
				}
				break;
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(323); match(Try);
				setState(324); block();
				setState(325); finallyProduction();
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(327); match(Try);
				setState(328); block();
				setState(329); catchProduction();
				setState(330); finallyProduction();
				}
				break;
			}
		}
	...
	public final CatchProductionContext catchProduction() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(334); match(Catch);
			setState(335); match(OpenParen);
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(346); match(Function);
			setState(347); match(Identifier);
			setState(348); match(OpenParen);
			setState(350);
			_la = _input.LA(1);
			if (_la==Identifier) {
				{
				setState(349); formalParameterList();
				}
			}

			setState(352); match(CloseParen);
			setState(353); match(OpenBrace);
			setState(354); functionBody();
			setState(355); match(CloseBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(368); match(OpenBracket);
			setState(370);
			switch ( getInterpreter().adaptivePredict(_input,28,_ctx) ) {
			case 1:
				{
				setState(369); elementList();
				}
				break;
			}
			setState(373);
			...
			if (_la==Comma) {
				{
				setState(375); elision();
				}
			}

			setState(378); match(CloseBracket);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ElementListContext elementList() throws RecognitionException {
		...
		try {
			...
			if (_la==Comma) {
				{
				setState(380); elision();
				}
			}

			setState(383); singleExpression(0);
			setState(391);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!= ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==Comma) {
						{
						setState(385); elision();
						}
					}

					setState(388); singleExpression(0);
					}
					}
				}
				setState(393);
	...
	public final ObjectLiteralContext objectLiteral() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(399); match(OpenBrace);
			setState(401);
			switch ( getInterpreter().adaptivePredict(_input,35,_ctx) ) {
			case 1:
				{
				setState(400); propertyNameAndValueList();
				}
				break;
			}
			setState(404);
	...
	public final PropertyNameAndValueListContext propertyNameAndValueList() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(408); propertyAssignment();
			setState(413);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!= ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(410); propertyAssignment();
					}
					}
				}
				setState(415);
	...
	public final PropertyAssignmentContext propertyAssignment() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(420); getter();
				setState(421); match(OpenParen);
				setState(422); match(CloseParen);
				setState(423); match(OpenBrace);
				setState(424); functionBody();
			...
			case 3:
				...
				{
				setState(427); setter();
				setState(428); match(OpenParen);
				setState(429); propertySetParameterList();
				setState(430); match(CloseParen);
				setState(431); match(OpenBrace);
				setState(432); functionBody();
	...
	public final PropertyNameContext propertyName() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				enterOuterAlt(_localctx, 1);
				{
				setState(437); identifierName();
				}
				break;
			case StringLiteral:
				enterOuterAlt(_localctx, 2);
				{
				setState(438); match(StringLiteral);
				}
				break;
			case DecimalLiteral:
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(444); match(OpenParen);
			setState(446);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << RegularExpressionLiteral) | (1L << OpenBracket) | (1L << OpenParen) | (1L << OpenBrace) | (1L << PlusPlus) | (1L << MinusMinus) | (1L << Plus) | (1L << Minus) | (1L << BitNot) | (1L << Not) | (1L << NullLiteral) | (1L << BooleanLiteral) | (1L << DecimalLiteral) | (1L << HexIntegerLiteral) | (1L << OctalIntegerLiteral) | (1L << Typeof) | (1L << New))) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (Void - 67)) | (1L << (Function - 67)) | (1L << (This - 67)) | (1L << (Delete - 67)) | (1L << (Identifier - 67)) | (1L << (StringLiteral - 67)))) != 0)) {
				{
				setState(445); argumentList();
				}
			}

			setState(448); match(CloseParen);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(450); singleExpression(0);
			setState(455);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==Comma) {
	...
	public final ExpressionSequenceContext expressionSequence() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(458); singleExpression(0);
			setState(463);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!= ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(460); singleExpression(0);
					}
					}
				}
				setState(465);
	...
	private SingleExpressionContext singleExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case Delete:
				...
				setState(468); singleExpression(30);
				}
				break;
			case Void:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(469); match(Void);
				setState(470); singleExpression(29);
				}
				break;
			case Typeof:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(471); match(Typeof);
				setState(472); singleExpression(28);
				}
				break;
			case PlusPlus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(473); match(PlusPlus);
				setState(474); singleExpression(27);
				}
				break;
			case MinusMinus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(475); match(MinusMinus);
				setState(476); singleExpression(26);
				}
				break;
			case Plus:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(477); match(Plus);
				setState(478); singleExpression(25);
				}
				break;
			case Minus:
				{
				...
				setState(480); singleExpression(24);
				}
				break;
			case BitNot:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(481); match(BitNot);
				setState(482); singleExpression(23);
				}
				break;
			case Not:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(483); match(Not);
				setState(484); singleExpression(22);
				}
				break;
			case Function:
				{
				...
				setState(489); match(OpenParen);
				setState(491);
				_la = _input.LA(1);
				if (_la==Identifier) {
					{
					setState(490); formalParameterList();
					}
				}

				setState(493); match(CloseParen);
				setState(494); match(OpenBrace);
				setState(495); functionBody();
				setState(496); match(CloseBrace);
				}
				break;
			case New:
				{
			...
			case OpenParen:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(508); match(OpenParen);
				setState(509); expressionSequence();
				setState(510); match(CloseParen);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			while ( _alt!=2 && _alt!= ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						consume();
						setState(516); singleExpression(22);
						}
						break;
					...
					case 2:
						...
						consume();
						setState(519); singleExpression(21);
						}
						break;
					...
					case 3:
						...
						consume();
						setState(522); singleExpression(20);
						}
						break;
					...
					case 4:
						...
						consume();
						setState(525); singleExpression(19);
						}
						break;
					...
					case 5:
						...
						setState(527); match(Instanceof);
						setState(528); singleExpression(18);
						}
						break;
					...
					case 6:
						...
						setState(530); match(In);
						setState(531); singleExpression(17);
						}
						break;
					...
					case 7:
						...
						consume();
						setState(534); singleExpression(16);
						}
						break;
					...
					case 8:
						...
						setState(536); match(BitAnd);
						setState(537); singleExpression(15);
						}
						break;
					...
					case 9:
						...
						setState(539); match(BitXOr);
						setState(540); singleExpression(14);
						}
						break;
					...
					case 10:
						...
						setState(542); match(BitOr);
						setState(543); singleExpression(13);
						}
						break;
					...
					case 11:
						...
						setState(545); match(And);
						setState(546); singleExpression(12);
						}
						break;
					...
					case 12:
						...
						setState(548); match(Or);
						setState(549); singleExpression(11);
						}
						break;
					...
					case 13:
						...
						setState(551); match(QuestionMark);
						setState(552); singleExpression(0);
						setState(553); match(Colon);
						setState(554); singleExpression(10);
						}
						break;
					...
					case 14:
						...
						setState(558); singleExpression(9);
						}
						break;
					...
					case 15:
						...
						setState(560); assignmentOperator();
						setState(561); singleExpression(8);
						}
						break;
					...
					case 16:
						...
						setState(564); match(OpenBracket);
						setState(565); expressionSequence();
						setState(566); match(CloseBracket);
						}
						break;
	...
	public final ReservedWordContext reservedWord() throws RecognitionException {
		...
		try {
			...
			case Yield:
				enterOuterAlt(_localctx, 2);
				{
				setState(597); futureReservedWord();
				}
				break;
			case NullLiteral:
			case BooleanLiteral:
	...
	public static final String _serializedATN =
		...
		"\3\2:S\3\2Tc\u02a5\2q\3\2\2\2\4v\3\2\2\2\6|\3\2\2\2\b\u008d\3\2\2\2\n"+
		"\u008f\3\2\2\2\f\u0096\3\2\2\2\16\u009a\3\2\2\2\20\u009e\3\2\2\2\22\u00a6"+
		"\3\2\2\2\24\u00aa\3\2\2\2\26\u00ad\3\2\2\2\30\u00af\3\2\2\2\32\u00b3\3"+
		"\2\2\2\34\u00f9\3\2\2\2\36\u00fb\3\2\2\2 \u0102\3\2\2\2\"\u0109\3\2\2"+
		"\2$\u0110\3\2\2\2&\u0116\3\2\2\2(\u011c\3\2\2\2*\u0129\3\2\2\2,\u012d"+
		"\3\2\2\2.\u0133\3\2\2\2\60\u0138\3\2\2\2\62\u013c\3\2\2\2\64\u014e\3\2"+
		"\2\2\66\u0150\3\2\2\28\u0156\3\2\2\2:\u0159\3\2\2\2<\u015c\3\2\2\2>\u0167"+
		"\3\2\2\2@\u0170\3\2\2\2B\u0172\3\2\2\2D\u017f\3\2\2\2F\u018d\3\2\2\2H"+
