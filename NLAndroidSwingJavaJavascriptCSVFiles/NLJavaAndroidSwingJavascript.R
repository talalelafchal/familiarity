library(plotly)
setwd("/Users/Talal/Tesi/familiarity/NLAndroidSwingJavaJavascriptCSVFiles")
data10  <- read.csv("nl10.csv")
data100  <- read.csv("nl100.csv")
data1000  <- read.csv("nl1000.csv")
data10000  <- read.csv("nl10000.csv")
data100000  <- read.csv("nl100000.csv")
