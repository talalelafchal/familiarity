...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_CUSTOMER_CITV = 2021;

    public static final int KEYCODE_CUSTOMER_CIBN = 2022;

    public static final int KEYCODE_CUSTOMER_SMARTHOME = 2023;

    public static final int KEYCODE_CUSTOMER_SCREENSHOT = 2024;

    public static final int KEYCODE_CUSTOMER_MOUSE = 2025;

    public static final int KEYCODE_DTV = 2026;

    private static final int LAST_KEYCODE = KEYCODE_DTV;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_CUSTOMER_CITV, "KEYCODE_CUSTOMER_CITV");
        names.append(KEYCODE_CUSTOMER_CIBN, "KEYCODE_CUSTOMER_CIBN");
        names.append(KEYCODE_CUSTOMER_SMARTHOME, "KEYCODE_CUSTOMER_SMARTHOME");
        names.append(KEYCODE_CUSTOMER_SCREENSHOT, "KEYCODE_CUSTOMER_SCREENSHOT");
        names.append(KEYCODE_CUSTOMER_MOUSE, "KEYCODE_CUSTOMER_MOUSE");
        names.append(KEYCODE_DTV, "KEYCODE_DTV");
    };
