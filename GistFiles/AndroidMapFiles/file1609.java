...
public class SettingProxy {
    public static final String LOG_TAG = "halfman";

    public static final String APPLICATION_NAME = "android.app.Application";
    ...
    public static boolean revertProxyICS(WebView webview) {
        try {
            Log.d(LOG_TAG, "Setting proxy with 4.0 API.");
    ...
    public static boolean revertProxyJB(WebView webview) {
    ...
    @SuppressLint("NewApi")
    @SuppressWarnings("all")
    public static boolean revertProxyKKPlus(WebView webView, String applicationClassName) {
