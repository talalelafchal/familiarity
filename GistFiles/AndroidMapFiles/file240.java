...
public class MainActivity extends AppCompatActivity implements
    ...
    protected TextView mPathDistanceTimeTextView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLatLong = (TextView) findViewById(R.id.latlong_text);
        mLastUpdateTimeTextView = (TextView) findViewById(R.id.last_update_time_text);
        mPathDistanceTimeTextView = (TextView) findViewById(R.id.path_distance_time);
    ...
    private void updateUI() {
        ...
        if (mCurrentLocation != null) {
            mLatLong.setText(String.format(Locale.ROOT, "%s: %f - %s: %f ",
                    mLatitudeLabel,
                    mCurrentLocation.getLatitude(),
                    mLongitudeLabel,
                    mCurrentLocation.getLongitude()));

            mLastUpdateTimeTextView.setText(String.format(Locale.ROOT, "%s: %s", mLastUpdateTimeLabel,
                    mLastUpdateTime));
        }
    }
