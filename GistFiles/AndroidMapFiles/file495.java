...
public class people_add extends Fragment {
	private ImageButton imbtnadd,imbtndel,imbtnupdata,imgbtnbark,imbtnedit;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		imbtnedit  = (ImageButton)v.findViewById(R.id.imbtnedit);
		imbtnadd = (ImageButton)v.findViewById(R.id.imbtnsave);
		imbtndel = (ImageButton)v.findViewById(R.id.imbtndel);
		imgbtnbark = (ImageButton)v.findViewById(R.id.imbtnbark);
		...
		imbtnedit.setOnClickListener(new OnClickListener(){
			
			//ADD
			public void onClick(View v) {
				// TODO Auto-generated method stub
				imbtnedit.setVisibility(8);
				imbtnadd.setVisibility(0);
		...
		imgbtnbark.setOnClickListener(new OnClickListener(){
