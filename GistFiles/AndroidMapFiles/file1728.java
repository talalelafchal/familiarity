...
public class ActCityList extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aa = new CityAdapter(cityList, getApplicationContext());
		lv.setAdapter(aa);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		startMapIntent.putExtra("lat", cityList.get(position).getLat());
		startMapIntent.putExtra("lng", cityList.get(position).getLng());
		
		startActivity(startMapIntent);
		super.onListItemClick(l, v, position, id);
	}
	
	private Document getXMLDocument(String city) {
		Document doc = null;
