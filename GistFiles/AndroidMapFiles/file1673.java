...
public class FingerprintAuthenticationDialogFragment extends DialogFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "disableBackup: " + FingerprintModule.mDisableBackup);

        // Inflate layout
        int fingerprint_dialog_container_id = getResources()
                .getIdentifier("fingerprint_dialog_container", "layout",
                        FingerprintModule.packageName);
        View v = inflater.inflate(fingerprint_dialog_container_id, container, false);

        // Set dialog Title
        int fingerprint_auth_dialog_title_id = getResources()
                .getIdentifier("fingerprint_auth_dialog_title", "id", FingerprintModule.packageName);
        TextView dialogTitleTextView = (TextView) v.findViewById(fingerprint_auth_dialog_title_id);
        if (null != FingerprintModule.mDialogTitle) {
            dialogTitleTextView.setText(FingerprintModule.mDialogTitle);
        }

        // Set dialog message
        int fingerprint_description_id = getResources()
                .getIdentifier("fingerprint_description", "id", FingerprintModule.packageName);
        TextView dialogMessageTextView = (TextView) v.findViewById(fingerprint_description_id);
        if (null != FingerprintModule.mDialogMessage) {
            dialogMessageTextView.setText(FingerprintModule.mDialogMessage);
        }

        // Set dialog hing
        int fingerprint_hint_id = getResources()
                .getIdentifier("fingerprint_status", "id", FingerprintModule.packageName);
        TextView dialogHintTextView = (TextView) v.findViewById(fingerprint_hint_id);
        if (null != FingerprintModule.mDialogHint) {
            dialogHintTextView.setText(FingerprintModule.mDialogHint);
        }

        int cancel_button_id = getResources()
                .getIdentifier("cancel_button", "id", FingerprintModule.packageName);
        mCancelButton = (Button) v.findViewById(cancel_button_id);
        if (null != FingerprintModule.mDialogCancel)
            mCancelButton.setText(FingerprintModule.mDialogCancel);
        mCancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FingerprintModule.onCancelled();
                dismiss();
            }
        });

        int second_dialog_button_id = getResources()
                .getIdentifier("second_dialog_button", "id", FingerprintModule.packageName);
        mSecondDialogButton = (Button) v.findViewById(second_dialog_button_id);
        if (FingerprintModule.mDisableBackup) {
        ...
        int fingerprint_container_id = getResources()
                .getIdentifier("fingerprint_container", "id", FingerprintModule.packageName);
        ...
        int fingerprint_icon_id = getResources()
                .getIdentifier("fingerprint_icon", "id", FingerprintModule.packageName);
    ...
    private void updateStage() {
        int cancel_id = getResources()
                .getIdentifier("cancel", "string", FingerprintModule.packageName);
        switch (mStage) {
            case FINGERPRINT:
                if (null != FingerprintModule.mDialogCancel)
                    mCancelButton.setText(FingerprintModule.mDialogCancel);
                ...
                int use_backup_id = getResources()
                        .getIdentifier("use_backup", "string", FingerprintModule.packageName);
            ...
            case BACKUP:
                ...
                if (FingerprintModule.mDisableBackup) {
                    FingerprintModule.onError("backup disabled");
                    return;
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_CONFIRM_DEVICE_CREDENTIALS) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                FingerprintModule.onAuthenticated(false /* used backup */);
            } else {
    ...
    public void onAuthenticated() {
        ...
        // successful.
        FingerprintModule.onAuthenticated(true /* withFingerprint */);
        dismiss();
    }
    ...
    public void onError(CharSequence errString) {
        if (!FingerprintModule.mDisableBackup) {
            ...
            FingerprintModule.onError(errString);
            dismiss();
