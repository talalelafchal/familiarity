...
public class StockMarketList extends StockMarketActivity {
    ...
    private final String streamdataioProxyPrefix = "https://stream.xignite.com/";
    //YOUR_TOKEN value needs to be replaced by yours.
    private final String streamdataioAppToken = "YOUR_TOKEN";
    private final String myApiWithToken = "xGlobalCurrencies.json/GetRealTimeRates?Symbols=GBPUSD,EURUSD&_token=" + streamdataioAppToken;
    ...
    private void connect() {
        ...
        try {
            String targetUrl = streamdataioProxyPrefix;
            eventSource = new EventSource(new URI(targetUrl), new URI(myApiWithToken), new SSEHandler(), headers);
    ...
    private class SSEHandler implements EventSourceHandler {
        ...
        public void onClosed(boolean willReconnect) {
            Log.i(TAG, "SSE Closed - reconnect? " + willReconnect);
            if (Log.isLoggable(TAG, Log.DEBUG)) {
    ...
    public class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mData != null) {
                ...
                //viewWrapper.titleTextView.setText(obj.get("Identifer").asText());
                //viewWrapper.priceLayout.setText(obj.get("Last").asText());
            }
            return convertView;
        }
