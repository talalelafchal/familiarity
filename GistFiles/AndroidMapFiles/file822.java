...
public class OblastyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String[] latitube = new String[RussianState.city.length];
        for (int i = 0; i < RussianState.city.length; i++) {

            oblastyNames[i] = RussianState.city[i].getName();

        }final String[] longitube = new String[RussianState.city.length];
        for (int i = 0; i < RussianState.city.length; i++) {
        ...
        RecyclerAdapter adapter = new RecyclerAdapter(oblastyNames, latitube, longitube, moscowImages);
