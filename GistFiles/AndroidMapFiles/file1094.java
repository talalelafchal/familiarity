...
public class people_add extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		/*imbtnupdata.setOnClickListener(new OnClickListener(){
			@Override
			...
			public void onClick(View v) {
				...
				query.getInBackground("gu0lvjAXib", new GetCallback<ParseObject>() {//GUERY OBJECT_ID ,利用OBJECT_ID UPDATE DATE
				  public void done(ParseObject gameScore, ParseException e) {
				    if (e == null) {
	...
	public void btnadd(){
    		...
    		if(edtadd.getText().toString().equals("")){
    			...
    			Toast.makeText(getActivity(), "地址不能空", Toast.LENGTH_LONG).show();
