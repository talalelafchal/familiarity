...
public class UpperFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        editText = (EditText)activity.findViewById(R.id.movie_name_edittext);
        checkBox = (CheckBox)activity.findViewById(R.id.internal_movies_checkbox);
        button = (Button)activity.findViewById(R.id.search_movie_button);
    }
