...
public class Socket {
    ...
    private final static int MAX_COLLISION = BuildConfig.DEBUG ? 5 : 7;
     ...
     */
    public Socket onEvent(String event, @NonNull OnEventListener listener){
     ...
     * @param listener message on arrive listener
     */
    public Socket onEventResponse(String event, @NonNull OnEventResponseListener listener){
