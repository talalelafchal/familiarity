...
public class QuestionFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        active = true;
        getActivity().registerReceiver(questionsBroadcastReceiver, new IntentFilter("com.google.android.c2dm.intent.RECEIVE"));
    }
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            new_questions_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    updateQuestions(Integer.parseInt(intent.getStringExtra("id")));
