...
public class PostLiveStreamingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play = (TextView) findViewById(R.id.capture);
        // restore data.
        ...
        final TextView btnPublish = (TextView) findViewById(R.id.capture);
...
//        });
    ...
    protected void onResume() {
        ...
        final TextView btn = (TextView) findViewById(R.id.capture);
        btn.setEnabled(true);
    }
