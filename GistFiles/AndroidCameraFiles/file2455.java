...
{
	/***********************************/
	static String MOBILE_NO = "7259235334";
	static int WAIT_ITERATION = 10;
	static int LAUNCH_ITERATION = 20;
	static boolean ett_selected = true;
	...
	{
		return "C:\\Users\\smechu\\Desktop\\Automation\\eAppRedmi4A\\";
	}
	 static String GetImagePath(String name)
	{
	 ...
	 public static void playSound()
	 {
		    ...
		    try
		    {
		        AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File(GetAutomationFolderPath()+"audio\\bank_alarm_1.wav").getAbsoluteFile());
	 ...
	 static void waitAndClick(Screen s, String path, int time) throws InterruptedException, FindFailed, IOException
	{
	 ...
	 public static int InstallAmazon(Screen s) throws InterruptedException, FindFailed, IOException
	 {
         ...
         ExecuteCommand("adb  shell input text smechu@vmware.com");//existing user
         Thread.sleep(3000);
	 ...
	 public static int InstallMyVodafone(Screen s) throws InterruptedException, FindFailed, IOException
	 {
         ...
         Thread.sleep(5000);
         ExecuteCommand("adb shell pm clear com.mventus.selfcare.activity");
         Thread.sleep(5000);
	     ...
	     waitAndClick(s,GetAppImagePath("myvodafone","myvodafone_launched.png"),1000);
	     Thread.sleep(3000);
	     if(ErrorCode == 1)
	     {
	        	 System.out.println("Manual Vodafone karo....");
	        	 playSound();
	        	 WaitForUserInput();
	        	 return 1;
	     }
	         
	     ExecuteCommand("adb  shell input tap 182 761");
	     Thread.sleep(6000);
	         
	     ExecuteCommand("adb  shell input tap 366 841");
	     Thread.sleep(6000);
	         
	     ExecuteCommand("adb  shell input tap 582 720");//sms
	     Thread.sleep(40000);
	     ...
	     if(ErrorCode == 1)
	     {
	         ...
	         waitAndClick(s,GetAppImagePath("myvodafone","done.png"),1000);
	         Thread.sleep(3000);
	         if(ErrorCode == 1)
	         {
	        	 System.out.println("Manual Vodafone karo....");
	         ...
	         waitAndClick(s,GetAppImagePath("myvodafone","close.png"),1000);
	         Thread.sleep(3000);
	         if(ErrorCode == 1)
	         {
	        	 System.out.println("Manual Vodafone karo....");
	         ...
	         ExecuteCommand("adb  shell input keyevent KEYCODE_BACK");
	         Thread.sleep(6000);
	         ExecuteCommand("adb  shell input tap 576 1102");
	         Thread.sleep(4000);
	         waitAndClick(s,GetAppImagePath("myvodafone","recharge.png"),1000);
	         Thread.sleep(3000);
	         if(ErrorCode == 1)
	         {
	        	 System.out.println("Manual Vodafone karo....");
	         ...
	         waitAndClick(s,GetAppImagePath("myvodafone","kishan.png"),1000);
	         Thread.sleep(3000);
	         if(ErrorCode == 1)
	         {
	        	 System.out.println("Manual Vodafone karo....");
	         ...
	         for(x = 0; x < LAUNCH_ITERATION; x++)
	         {
	       	      if(s.exists(GetAppImagePath("myvodafone","proceed.png")) != null)
	 	          {
	       	              ExecuteCommand("adb  shell input text 20");
	       	              Thread.sleep(3000);
			       		  break;
	 	          }
	       	      Thread.sleep(3000);
	         ...
	         waitAndClick(s,GetAppImagePath("myvodafone","proceed.png"),1000);
	         Thread.sleep(3000);
	 ...
	 public static int Installwyncgames(Screen s) throws InterruptedException, FindFailed, IOException
	 {
		 ...
		 if(s.exists(GetImagePath("wyncgames.png")) == null)
		 {
     	 ...
     	 Thread.sleep(5000);
     	  ...
     	  waitAndClick(s,GetAppImagePath("wyncgames","download.png"),1000);
     	  Thread.sleep(2000);
	 ...
	 public static int InstallDream11(Screen s) throws InterruptedException, FindFailed, IOException
	 {
		 ...
		 if(s.exists(GetImagePath("dream11.png")) == null)
		 {
     	 ...
     	 Thread.sleep(5000);
     	  ...
     	  waitAndClick(s,GetAppImagePath("dream11","download.png"),1000);
     	  Thread.sleep(2000);
     	  for(int x = 0; x < 60; x++)
      	  {
         	  if(s.exists(GetAppImagePath("wyncgames","harm_ok.png")) != null)
	 ...
	 public static int InstallAce2Three(Screen s) throws InterruptedException, FindFailed, IOException
	 {
     	...
     	Thread.sleep(15000);
 	     ...
 	     waitAndClick(s,GetAppImagePath("ace2three","download_play.png"),1000);
      	  ...
      	  for(int x = 0; x < 60; x++)
      	  {
         	  if(s.exists(GetAppImagePath("ace2three","harm_ok.png")) != null)
         	  {
         		  s.click(GetAppImagePath("ace2three","harm_ok.png"));
         		 Thread.sleep(3000);
         	  }
         	  
         	  if(s.exists(GetAppImagePath("ace2three","download.png")) != null)
         	  {
         		  s.click(GetAppImagePath("ace2three","download.png"));
         		 Thread.sleep(3000);
         	  }

      		  if(s.exists(GetAppImagePath("ace2three","open.png")) != null)
      		  {
      			s.click(GetAppImagePath("ace2three","open.png"));
      			break;
      		  }
      		  Thread.sleep(1000);
      	  }
	 ...
	 public static void ProcessApps(Screen s) throws InterruptedException, FindFailed, IOException
	 {
	    ...
	    if(GetAppFlagFromFile("fdream11") == 1)
	    {
		 ...
		 {
    		 WriteLog("Installing QPAY....");
        	 result =  CheckAndInstallApp(s,"qpay");
        	 WriteLog("qpay = " + result);
        	 countApps = countApps + result;
        	 WriteLog("Installing qpay Done");
	    }
     ...
     {
     	 int index1 = index;
	     FileInputStream tfstream = new FileInputStream("C:\\Users\\smechu\\Desktop\\Automation\\eAppRedmi4A\\Input\\temp.txt");
	     DataInputStream tin = new DataInputStream(tfstream);
	     BufferedReader tbr = new BufferedReader(new InputStreamReader(tin));

	     BufferedWriter bsx = new BufferedWriter(new FileWriter("C:\\Users\\smechu\\Desktop\\Automation\\eAppRedmi4A\\Input\\temp_out.txt"));
	     String xbrLine = null;
     ...
     public static void FilterDuplicates() throws NumberFormatException, IOException
     {
	     ...
	     BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\smechu\\Desktop\\Automation\\eAppRedmi4A\\Input\\duplicates.txt"));
