...
public final class CameraManager {
    ...
    private static final int MAX_FRAME_WIDTH = 800; // = 5/8 * 1920
    ...
    /**
     * Convenience method for {@link com.ctrlsmart.fpcx.CaptureActivity}
     *
     ...
     *
     * @param deltaWidth  The width in pixels to scan.
     * @param deltaHeight The height in pixels to scan.
     */
    public synchronized void setManualFramingRect(int deltaWidth, int deltaHeight) {
        if (initialized) {
            Point screenResolution = configManager.getScreenResolution();
