...
public class NerdLauncherFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<ResolveInfo> adapter=new ArrayAdapter<ResolveInfo>(getActivity(), R.layout.simple_list_item_1,activities){
            @Override
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                tv.setText(ri.loadLabel(pm)+"  "+ri.toString());
                return view;
            }
        };
