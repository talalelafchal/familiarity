...
//  protected Window window;
  ...
  /**
   * RESULT_* codes are used to identify selectSomething() calls 
   * in onActivityResult().
   */
  static private final int RESULT_SELECT = 1000;

  static private final String SELECT_CALLBACK = "selectCallback";
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    if (resultCode == RESULT_OK) {
      if (requestCode == RESULT_SELECT) {
        File selectedFile = new File(data.getStringExtra(SelectActivity.EX_PATH_RESULT));
        String callbackMethod = data.getStringExtra(SELECT_CALLBACK);
        selectCallback(selectedFile, callbackMethod, this);
      }
    } else {
...
//    }
  ...
  */
  ...
  protected void selectImpl(final String prompt,
    ...
    i.putExtra(SELECT_CALLBACK, callbackMethod);
