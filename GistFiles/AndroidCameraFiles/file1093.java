...
public class AutoResizeTextView extends EditText {
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14, getResources().getDisplayMetrics());
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSPace) {
                ...
                if (singleLine) {
                    ...
                    Log.d("sizebottom",String.valueOf(suggestedSize));
                    Log.d("sizeright",String.valueOf(textRect.right));
