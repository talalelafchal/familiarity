...
public class ComposeMessageFragment extends ListFragment implements
    ...
    */
    ...
    private void startRecording() {
        try {
            mRecordFile = MediaStorage.getTempAudio(getActivity().getApplicationContext());
        }
        catch (IOException e) {
        ...
        try {
            ...
            new AlertDialog.Builder(getActivity().getApplicationContext())
                    ...
                    .setNegativeButton(getActivity().getApplicationContext().getString(android.R.string.ok), (DialogInterface.OnClickListener) null)
                    .show();
        }
