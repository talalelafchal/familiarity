...
public class ActiveStudent {
    ...
    public ActiveStudent(int _id, String _student, String _attend_time) {
    ...
    public ActiveStudent(String _student, String _attend_time) {

        this._student = _student;
        this._attend_time = _attend_time;
    }

    public ActiveStudent(String _student) {
        this._student = _student;
    }
