library(plotly)
setwd("/Users/Talal/Tesi/familiarity/AndroidSwingJavaFormattedPunctuationCSVFiles/")
...
chart_link = plotly_POST(p, filename="JAVA-Removed-All-Punctuations-Andorid-Swift")