...
data10  <- read.csv("nLMeanAggregation10.csv")
data100  <- read.csv("nLMeanAggregation100.csv")
data1000  <- read.csv("nLMeanAggregation1000.csv")
data10000  <- read.csv("nLMeanAggregation10000.csv")
data100000  <- read.csv("nLMeanAggregation100000.csv")
...
chart_link = plotly_POST(p, filename="NlAgregationByMean")