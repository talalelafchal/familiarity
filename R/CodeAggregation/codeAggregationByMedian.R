...
data10  <- read.csv("codeMedianAggregation10.csv")
data100  <- read.csv("codeMedianAggregation100.csv")
data1000  <- read.csv("codeMeanAggregation1000.csv")
data10000  <- read.csv("codeMedianAggregation10000.csv")
data100000  <- read.csv("codeMedianAggregation100000.csv")
...
chart_link = plotly_POST(p, filename="CodeAgregationByMedian")